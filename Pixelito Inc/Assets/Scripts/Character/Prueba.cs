...
public class Prueba : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        Debug.DrawRay(this.transform.position, Vector2.down * 0.15f, Color.cyan);
        ...
        if (grounded == true && gameObject.layer == 9 && Input.GetKey(KeyCode.S))
        {
            oneway.layer = 0;
            lamps1.layer = 0;
            lamps2.layer = 0;
    ...
    //Agregar y corregir el salto, buscar bien como hacer esto con raycast o mirar como lograrlo con el producto punto.
    ...
    /*private void Ice()
    {
        if (touch_ice == true)
       {
           if (dirRig == true)
           {
               rb.AddForce(Vector2.right * 8f * -1f);
               dirRig = false;
           }
           if (dirLef == true)
           {
